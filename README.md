...
├── Dash_Board_AlarmClock/      Web Dashboard (React + Firebase)
├── Schematic_DoAn1.pdf         Circuit schematic
├── Datasheet/                  Datasheets: DHT22, DS1307, LCD
├── firebase.pdf                Firebase setup guide
